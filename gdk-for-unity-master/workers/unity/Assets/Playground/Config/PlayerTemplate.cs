...
namespace Playground
{
    public static class PlayerTemplate
    {
        public static EntityTemplate CreatePlayerEntityTemplate(string workerId, Improbable.Vector3f position)
        {
            ...
            var baseUnitSpawner = BaseUnitSpawner.Component.CreateSchemaComponentData(new List<EntityId>());
            ...
            var entityBuilder = EntityBuilder.Begin()
                ...
                .AddMetadata("CharacterTest", WorkerUtils.UnityGameLogic)
                ...
                .AddComponent(baseUnitSpawner, WorkerUtils.UnityGameLogic)
